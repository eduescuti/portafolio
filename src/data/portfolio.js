...
export const projects = [
  ...
  },
  {
    ...
    tech: ['Supabase', 'Brevo', 'PostgreSQL', 'JWT'],
    highlights: {
  ...
  },
  {
    ...
    subtitle: { es: 'Andersson Consultores', en: 'Andersson Consultores' },
    description: {
      es: 'CRM para secretarias: conversaciones WhatsApp con drag & drop, filtros, respuestas rápidas y uso de AI Agents y Bots de respuesta. Backend Node.js con Supabase y PostgreSQL.',
      en: 'CRM for secretaries: WhatsApp chats with drag & drop, filters, quick replies, AI Agents and Bots. Backend with Supabase and PostgreSQL.',
    },
    tech: ['n8n', 'Supabase', 'PostgreSQL', 'AI Agents', 'Bots'],
    highlights: {
      es: ['Filtros', 'Respuestas rápidas', 'Tiempo real'],
      en: ['Filters', 'Quick replies', 'Real-time'],
    },
